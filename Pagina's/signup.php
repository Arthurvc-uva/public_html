      ...
      <div class="col-md-12">
        ...
        <form action="signup.php" method="post">
          <div class="control-group"> 
            ...
            <input type="text" class="form-control bg-transparent p-4" id="firstname" name="firstname" class="form-control" required>
          </div>
          <br>
          <div class="control-group">
            <label>Last name</label>
            <input type="text" class="form-control bg-transparent p-4" id="lastname" name="lastname" class="form-control" required>
          </div>
          <br>
          <div class="control-group">
            <label>E-mail Adress</label>
            <input type="text" class="form-control bg-transparent p-4" id="Email" name="email" class="form-control" required>
          </div>
          <br>
          <div class="control-group">
            <label>Username</label>
            <input type="text" class="form-control bg-transparent p-4" id="Username" name="username" class="form-control" required>
          </div>
          <br>
          <div class="control-group">
            <label>Password:</label>
            <input type="password" class="form-control bg-transparent p-4" id="Password" name="password" class="form-control" required>
          </div>
          <br>
          <div class="control-group">
            <label>Confirm password:</label>
            <input type="password" class="form-control bg-transparent p-4" name="cpassword" class="form-control" required>
          </div>
          <br>
          <div class="btn btn-primary font-weight-bold py-3 px-5">
